...
def train_model(run_name):
    ...
    # Build model.
    combined_model = build_combined_model(image_size + [1], lambda_l2)
    # Log likelihood has to be scaled because kl-losses are not directly accessible.
    combined_model.compile(loss=lambda y, f: batch_size*negloglik(y, f),
...
if __name__ == '__main__':
    ...
    train_model(run_name='combined_01')
